...
KEY = json.loads(_read(os.path.join(SITE, "planted.json")))
...
class Captures(unittest.TestCase):
    ...
    def test_crawl_html_matches_the_site(self):
        ...
        self.assertEqual(_read(os.path.join(html, "1-index.html")),
                         _read(os.path.join(SITE, "index.html")))
        self.assertEqual(_read(os.path.join(html, "3-pricing.html")),
                         _read(os.path.join(SITE, "pricing.html")))
...
class AnswerKey(unittest.TestCase):
    ...
    def test_planted_text_is_really_on_the_pages(self):
        ...
        idx = _read(os.path.join(SITE, "index.html"))
        ...
        self.assertIn('name="robots" content="noindex"', _read(os.path.join(SITE, "pricing.html")))
        about = _read(os.path.join(SITE, "about.html"))
        self.assertIn("Priya Raman", about)                    # the clean item
        self.assertIn("FAQPage", about)
        app = os.path.join(SITE, "app")
        self.assertIn("Saved ✓", _read(os.path.join(app, "new.html")))
        self.assertIn("Tuesday afternoons", _read(os.path.join(app, "memories.html")))
    ...
    def test_fixture_names_no_real_product(self):
        ...
        text = " ".join(_read(f, errors="replace").lower()
